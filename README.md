...
9. Print in google with **Pages:** print only the sheet called **Print - DONT TOUCH** and choose **Scale: fit to width** and **margins: narrow**. After that print the PDF generated by google with your printer. You can **Use any QR reader** available on your phone to scan the QR codes generated in the sheet named "Print - DONT TOUCH".
...
5. Print in google with **Pages:** print only the sheet called **Print - DONT TOUCH** and choose **Scale: fit to width** and **margins: narrow**. After that print the PDF generated by google with your printer. You can **Use any QR reader** available on your phone to scan the QR codes generated in the sheet named "Print - DONT TOUCH".
#### WARNINGS
